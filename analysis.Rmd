...
### Alternative A - Main version, but splits high education level into Highschool and Bachelors
...
### Alternative B - Alternative A, but using groups from bivariate analyses
...
### Alternative C - Alternative B, but age and doses are covariates
...
### Alternative D - Alternative C, but it includes all categories from bivariate analyses
...
### Alternative E - Alternative C, but doses and are are categorical
